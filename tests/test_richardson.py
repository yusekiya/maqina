...
def test_python_richardson_matches_rust(n: int, seed: int, extrapolate: bool) -> None:
    ...
    psi_py, err_py = _python_cfm4_step_with_richardson_estimate(
        psi,
        h_x,
        h_p_diag,
        a_s1_full,
    ...
    psi_rust, err_rust = _rust_mod.cfm4_step_with_richardson_estimate_py(
        psi,
        h_x,
        h_p_diag,
        a_s1_full,
...
def test_python_richardson_err_scaling_dt_fifth() -> None:
    ...
    for dt in dts:
        ...
        _, err = _python_cfm4_step_with_richardson_estimate(
            psi,
            h_x,
            h_p_diag,
            a_s1_full,
...
def test_python_richardson_extrapolate_improves_accuracy() -> None:
    ...
    def _ratio_set(extrapolate: bool, dts: list[float]) -> list[float]:
        ...
        for dt in dts:
            ...
            psi_new, _ = _python_cfm4_step_with_richardson_estimate(
                psi,
                h_x,
                h_p_diag,
                a_s1_full,
...
def test_python_richardson_dt_zero_err_zero() -> None:
    ...
    for extrapolate in (False, True):
        psi_new, err = _python_cfm4_step_with_richardson_estimate(
            psi,
            h_x,
            h_p_diag,
            0.3,
