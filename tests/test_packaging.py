...
def test_import_kryanneal() -> None:
    ...
    assert hasattr(kryanneal, "set_blas_threads_auto")
    assert callable(kryanneal.set_blas_threads)
    assert callable(kryanneal.available_blas_threads)
    assert callable(kryanneal.set_blas_threads_auto)
...
def test_recommended_blas_threads_returns_positive_int() -> None:
    ...
    from kryanneal import _recommended_blas_threads
...
def test_read_env_cap_priority(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from kryanneal import _read_env_cap
...
def test_set_blas_threads_auto_returns_applied_value() -> None:
    ...
    """
    from kryanneal import _recommended_blas_threads, set_blas_threads_auto
