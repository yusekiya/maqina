...
//! | `matvec_only` | `apply_h_kryanneal` 1 call | matvec 単独 (`perf_apply_h` と同等; Chebyshev / Lanczos 共通の最下層) |
//!
...
use _rust::bench_api::{
    apply_h_kryanneal, cfm4_step_chebyshev_with_richardson_estimate, chebyshev_propagate,
};
