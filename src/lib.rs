//! `kryanneal._rust`: Rust 実装の Krylov / CFM4 / matvec 高速経路.
//!
...
//!
//! Phase 2 で `cfm4_step` (CFM4:2 commutator-free Magnus, Alvermann-Fehske 2011).
//!
//! Phase 3 で `cfm4_step_with_m2_estimate` (M2 embedded error 推定子) と
