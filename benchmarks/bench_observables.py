...
CLI 例::
    ...
    uv run python benchmarks/bench_observables.py \\
        --methods m2,cfm4,cfm4_adaptive_richardson --n-values 4,8 --repeat 3
...
* ``"m2"`` (固定 dt)
* ``"cfm4"`` (固定 dt)
* ``"cfm4_adaptive_richardson"`` (adaptive PI controller; ``save_tlist``
...
_VALID_METHODS: tuple[str, ...] = ("m2", "cfm4", "cfm4_adaptive_richardson")
