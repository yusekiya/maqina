...
| §5.1 | [05-1-matvec.md](05-1-matvec.md) | 数値カーネル — matvec / per-axis primitives。`apply_h_kinema`, `apply_single_mode_axis_i`, Phase 6 C3 (gate fusion), Phase 6 D アーカイブ |
...
| §5.1.1 | `apply_h_kinema` (Phase 1) | [05-1-matvec.md](05-1-matvec.md) |
...
| §7.3 | `apply_h_kinema` の Python 公開 | [07-rust-extension.md](07-rust-extension.md) |
...
| **`apply_h_kinema` の Phase 6 進化** | [§5.1.1](05-1-matvec.md) → [§5.1.3](05-1-matvec.md) → [§5.1.4](05-1-matvec.md) | issues #62, #63, #64, #79 |
