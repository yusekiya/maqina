...
| **Chebyshev propagator** (時間独立 / CFM4 統合 / アルゴリズム軸の cache stall 回避 / inner loop SIMD + fusion) | [§5.3](05-3-propagator.md) "CFM4:2 + Chebyshev variant" 節 + "Chebyshev recurrence の SIMD + fusion" 節 | `src/chebyshev.rs`, `src/bin/perf_chebyshev.rs`, `src/bin/perf_cfm4_richardson_chebyshev.rs`, issues #120 #122 #126, `CLAUDE.md` Phase B 節 + Phase B follow-up |
