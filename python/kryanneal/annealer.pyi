...
import numpy as np
from kryanneal.krylov import evolve_schedule_cfm4 as evolve_schedule_cfm4, evolve_schedule_m2 as evolve_schedule_m2, evolve_schedule_trotter as evolve_schedule_trotter, evolve_schedule_trotter_suzuki4 as evolve_schedule_trotter_suzuki4
...
class QuantumAnnealer:
    ...
    def run(self, psi0: np.ndarray, t0: float, t1: float, *, method: Literal['m2', 'trotter', 'trotter_suzuki4', 'cfm4']='m2', n_steps: int, save_tlist: np.ndarray | None=None) -> QuantumResult:
